...
class Order(models.Model):
    o_user = models.ForeignKey(AXFUser,related_name='od',on_delete=models.CASCADE)
...
class OrderGoods(models.Model):
    o_order = models.ForeignKey(Order,related_name='og',on_delete=models.CASCADE)
    o_goods = models.ForeignKey(Goods,related_name='ods',on_delete=models.CASCADE)
